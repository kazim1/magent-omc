...
Oppc.prototype = {
    initialize: function(urls){
        ...
        this.steps = ['login', 'billing_shipping', 'shipping_method','payment', 'review'];
        //We use billing as beginning step since progress bar tracks from billing
        this.currentStep = 'billing_shipping';
    },
    ...
    _onSectionClick: function(event) {
        ...
        if (section.hasClassName('allow')) {
            Event.stop(event);
            this.gotoSection(section.readAttribute('id').replace('oppc-', ''), false);
            return false;
        }
    },
    ...
    gotoSection: function (section, reloadProgressBlock) {
		...
		jQuery('.oppc-step').removeClass("oppc-show");
        this.currentStep = section;
        var sectionElement = $('oppc-' + section);
		sectionElement.addClassName('allow');
		sectionElement.addClassName('oppc-show');
    ...
    changeSection: function (section) {
        var changeStep = section.replace('oppc-', '');
    ...
    setBilling: function() {
        if (($('billing:use_for_shipping_yes')) && ($('billing:use_for_shipping_yes').checked)) {
            ...
            $('oppc-shipping').addClassName('allow');
...
//        //this.accordion.openNextSection(true);
    ...
    back: function(){
        ...
        while (sectionElement === null && stepIndex > 0) {
            ...
            sectionElement = $('oppc-' + section);
        }
        this.changeSection('oppc-' + section);
    },
